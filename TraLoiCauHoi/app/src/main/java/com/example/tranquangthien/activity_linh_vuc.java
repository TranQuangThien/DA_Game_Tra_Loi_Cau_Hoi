...
public class activity_linh_vuc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLV1 = findViewById(R.id.btn_CauA);
        btnLV2 = findViewById(R.id.btn_CauB);
        btnLV3 = findViewById(R.id.btn_CauC);
        btnLV4 = findViewById(R.id.btn_CauD);
        ...
        public void onLoadFinished(@NonNull Loader<String> loader, String data) {
            try {
                ...
                if(CauHinhVaLuuTru.mDSCauHoi.size()>0){
                    getSupportLoaderManager().destroyLoader(LAY_DS_CAU_HOI);
                    Intent intent = new Intent(_context,activity_Trochoi.class);
